...
INSERT INTO "new_Post" ("authorId", "communityId", "content", "createdAt", "engagementScore", "externalId", "feedSourceId", "fetchedAt", "freshnessScore", "id", "isFeedVisible", "lastScoredAt", "score", "sharedDescription", "sharedImageUrl", "sharedPostId", "sharedSource", "sharedTitle", "sharedUrl", "sourceScore", "titleHash", "urlHash") SELECT "authorId", "communityId", "content", "createdAt", "engagementScore", "externalId", "feedSourceId", "fetchedAt", "freshnessScore", "id", "isFeedVisible", "lastScoredAt", "score", "sharedDescription", "sharedImageUrl", "sharedPostId", "sharedSource", "sharedTitle", "sharedUrl", "sourceScore", "titleHash", "urlHash" FROM "Post";
DROP TABLE "Post";
